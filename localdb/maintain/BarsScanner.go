...
/* Interface BarsScanable has three method.

   Len() int, GetBar(int) interface{}, GetCurrentDate(int) time.Time
...
func (this *BarsScanner) ScanByPeriodType(pt c.PeriodType) bool {
	switch pt {
	case c.Period_W:
	...
	case c.Period_Y:
		return this.scanPeriod(t.IsSameYear)
	}
	return false
}
...
func (this *BarsScanner) ScanAYear() bool {
	return this.scanPeriod(t.IsSameYear)
}
